DEFAULT_SETTINGS_FOR_SCRAPY = {
    ...
    'DOWNLOADER_MIDDLEWARES': {
        "invana_bot2.contrib.middlewares.downloaders.controllers.IgnoreTraversalRequestsController": 111,
        "invana_bot2.contrib.middlewares.downloaders.controllers.SpiderRequestsBasedStopController": 112,
